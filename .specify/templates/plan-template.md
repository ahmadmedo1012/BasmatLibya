...
- **G1 — Arabic-First & RTL by Default**: every user-facing surface built RTL-first
...
- **G5 — AI-Ready & Simplicity**: enrichment slot reserved as no-op; YAGNI;
  one-command dev (Principle V).
- **G6 — Technology Stack Constraints**: MUST use ratified stack; deviation
  requires Complexity Tracking justification.
- **G7 — Development Workflow Compliance**: speckit flow, Conventional Commits,
